...
describe('Recintos do Zoologico', () => {
    ...
    test('Deve encontrar recintos para gazela', () => {
    ...
    test('Deve encontrar recintos para hipopotamos', () => {
    ...
    test('Deve encontrar recinto para leão', () => {
    ...
    test('Deve encontrar recinto para leopardo', () => {
